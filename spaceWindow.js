...
class SpaceWindow
{
    ...
    static createNewWindow(title = "New Window", htmlBody = "HTML body")
    {
        ...
        <div class="spaceWindow-topBar">
            ...
            <div class="spaceWindow-topBar-closeButton spaceWindow-topBar-button" onclick="SpaceWindow.closeWindow(this)">
    ...
    static closeWindow(element)
    {
        let spaceWindow = element.parentElement.parentElement;
        spaceWindow.setAttribute("class","spaceWindow");
    }
